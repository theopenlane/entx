...
// NewAccessMapExt creates a new accessmap extension
func NewAccessMapExt(opts ...ExtensionOption) *Extension {
	extension := &Extension{
...
func (a AccessMapAnnotations) Name() string {
...
func EdgeAuthCheck(objectType string) AccessMapAnnotations {
...
func EdgeNoAuthCheck() AccessMapAnnotations {
	return AccessMapAnnotations{
		SkipEditCheck: true,
	}
}
